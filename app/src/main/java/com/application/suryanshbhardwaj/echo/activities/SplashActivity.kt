...
class SplashActivity : AppCompatActivity() {
    ...
    var permissionsString = arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.MODIFY_AUDIO_SETTINGS,
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when(requestCode){
            131->{
                ...
                Toast.makeText(this@SplashActivity,"Something went wromg",Toast.LENGTH_SHORT).show()
                this.finish()
                return;
            }
        }
